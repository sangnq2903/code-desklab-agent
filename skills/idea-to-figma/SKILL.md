...
- Chất lượng: một hành động chính mỗi màn, tương phản chữ/nền ≥ 4.5:1, vùng chạm ≥ 44px, chữ không dưới 12px, không dùng emoji làm icon (vẽ icon đơn giản bằng shape hoặc chữ ký hiệu rõ ràng, ghi chú nếu thay bằng placeholder), nội dung mẫu thật (tên, số, giá) thay vì "Lorem ipsum".
